...
class Blog extends Component {
    ...
    //Corazon de desplazamiento infinito, con onscroll detectamos el scroll
    onScroll() {               
        /*si se cumple este condicional salta todo lo que sigue de la funcion,
        la rompe y sale fuera de ella.*/
        if (
    ...
    getBlogItems(){
        ...
        axios.get(`https://carlosterrero.devcamp.space/portfolio/portfolio_blogs?page=${this.state.currentPage}`, { 
    ...
    /* Con esta funcion hacemos que esta funcion desaparezca cuanel el componente 
    no esta en uso */
